    ...
    companion object {
        ...
        fun of(user: User, userInformation: UserInformation?): CurrentUserResponse {
            return CurrentUserResponse(
                ...
                specialCaseRegistered = userInformation?.specialCaseRegistered,
                specialCaseRegisteredDate = userInformation?.specialCaseRegisteredDate,
                disabilityRegistered = userInformation?.disabilityRegistered,
